        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="{{URL::to('/addbrand')}}" method="post">
                        {{csrf_field()}}
                        <div class="form-group">

                            <div class="form-group">
                                <label>Tên Thương Hiệu</label>
                                <input class="form-control" type="text" name="name_brand" required>
                            </div>

                            <div class="form-group">
                                <label>Mô Tả Thương Hiệu</label>
                                <input class="form-control" type="text" name="desc_brand" required>
                            </div>
