...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 05, 2023 lúc 07:11 PM
...
(5, 'Nguyễn Minh Nghĩa', 'nghia@gmail.com', '0123456789', '123', 'KĐT Linh Đàm', NULL, NULL);
...
(1, 1, 1, 1, 73916000, 'Hủy Đơn Hàng', NULL, NULL),
(2, 4, 2, 2, 18890000, 'Đã Xác Nhận Đơn Hàng', NULL, NULL),
(3, 2, 3, 3, 228160000, 'Đang Vận Chuyển', NULL, NULL),
(4, 3, 4, 4, 347800000, 'Đã Xác Nhận Đơn Hàng', NULL, NULL),
(5, 5, 5, 5, 22870000, 'Đã Xác Nhận Đơn Hàng', NULL, NULL),
(6, 1, 6, 6, 21600000, 'Đã Xác Nhận Đơn Hàng', NULL, NULL),
(7, 1, 7, 7, 168000000, 'Chờ Xác Nhận Đơn Hàng', NULL, NULL);
...
(10, 5, 1, 'IPhone 11', 8000000, 2, NULL, NULL),
(11, 5, 15, 'Xiaomi Mi Watch BHR4583GL', 2290000, 3, NULL, NULL),
(12, 6, 2, 'Samsung Galaxy A54', 5400000, 4, NULL, NULL),
(13, 7, 1, 'IPhone 11', 8000000, 21, NULL, NULL);
...
(5, 'Thanh Toán Khi Nhận Hàng', NULL, NULL),
(6, 'Thanh Toán Khi Nhận Hàng', NULL, NULL),
(7, 'Thanh Toán Khi Nhận Hàng', NULL, NULL);
...
(5, 'Nghĩa Minh', '0987651231', 'Bằng Liệt', 'Không có', '2023-07-02 07:01:58', NULL),
(6, 'Nam Doan', '0326684220', '12 nguyễn minh', 'Giao lên tầng', '2023-07-05 01:53:13', NULL),
(7, 'Bùi Nam', '0326684220', '72 trần đại nghĩa', NULL, '2023-07-05 14:16:06', NULL);
...
--
ALTER TABLE `tbl_order_detail`
  MODIFY `orderdetail_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `tbl_shoppingcustomer`
  MODIFY `shoppingcustomer_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
